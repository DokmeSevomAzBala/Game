...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_timerThread_t, stringdata) + ofs \
...
QT_MOC_LITERAL(3, 22, 6) // "myslot"

    },
    "timerThread\0mysignal\0\0myslot"
};
...
void timerThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&timerThread::mysignal)) {
                *result = 0;
            }
        }
    }
...
void *timerThread::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_timerThread.stringdata))
