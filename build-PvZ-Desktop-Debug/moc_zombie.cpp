...
const QMetaObject zombie::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_zombie.data,
      qt_meta_data_zombie,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *zombie::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_zombie.stringdata))
