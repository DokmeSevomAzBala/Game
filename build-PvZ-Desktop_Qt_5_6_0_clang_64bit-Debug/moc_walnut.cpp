...
struct qt_meta_stringdata_walnut_t {
    QByteArrayData data[1];
    char stringdata0[7];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_walnut_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_walnut_t qt_meta_stringdata_walnut = {
    {
QT_MOC_LITERAL(0, 0, 6) // "walnut"
...
void walnut::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    Q_UNUSED(_o);
    Q_UNUSED(_id);
    Q_UNUSED(_c);
...
const QMetaObject walnut::staticMetaObject = {
    { &plant::staticMetaObject, qt_meta_stringdata_walnut.data,
      qt_meta_data_walnut,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *walnut::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_walnut.stringdata0))
